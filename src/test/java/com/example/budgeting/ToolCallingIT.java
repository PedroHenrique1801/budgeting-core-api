...
public class ToolCallingIT {
    ...
    @Test
    void should_executeSum_when_prompted() throws InterruptedException {
        ...
        var response = chatClient.prompt("Soma 10 mais 20. Depois subtraia 30 do resultado anterior.")
                .call().content();
